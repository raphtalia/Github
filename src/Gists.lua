...
function Gists.createAGistComment(gist_id, body)
	return Gists.Http:POST(("https://api.github.com/gists/%s/comments"):format(gist_id), body)
end
...
function Gists.updateAGistComment(gist_id, comment_id, body)
	return Gists.Http:PATCH(("https://api.github.com/gists/%s/comments/%s"):format(gist_id, comment_id), body)
end
