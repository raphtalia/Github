...
function Teams.createATeam(org, body)
	return Teams.Http:POST(("https://api.github.com/orgs/%s/teams"):format(org), body)
end
...
function Teams.updateATeamLegacy(team_id, body)
	return Teams.Http:PATCH(("https://api.github.com/teams/%s"):format(team_id), body)
end
...
function Teams.addOrUpdateTeamProjectPermissionsLegacy(team_id, project_id, body)
	return Teams.Http:PUT(("https://api.github.com/teams/%s/projects/%s"):format(team_id, project_id), body)
end
...
function Teams.addOrUpdateTeamRepositoryPermissionsLegacy(team_id, owner, repo, body)
	return Teams.Http:PUT(("https://api.github.com/teams/%s/repos/%s/%s"):format(team_id, owner, repo), body)
end
...
function Teams.createADiscussionLegacy(team_id, body)
	return Teams.Http:POST(("https://api.github.com/teams/%s/discussions"):format(team_id), body)
end
...
function Teams.updateADiscussionLegacy(team_id, discussion_number, body)
	return Teams.Http:PATCH(("https://api.github.com/teams/%s/discussions/%s"):format(team_id, discussion_number), body)
end
...
function Teams.createADiscussionCommentLegacy(team_id, discussion_number, body)
	return Teams.Http:POST(("https://api.github.com/teams/%s/discussions/%s/comments"):format(team_id, discussion_number), body)
end
...
function Teams.updateADiscussionCommentLegacy(team_id, discussion_number, comment_number, body)
	return Teams.Http:PATCH(("https://api.github.com/teams/%s/discussions/%s/comments/%s"):format(team_id, discussion_number, comment_number), body)
end
...
function Teams.addOrUpdateTeamMembershipForAUserLegacy(team_id, username, body)
	return Teams.Http:PUT(("https://api.github.com/teams/%s/memberships/%s"):format(team_id, username), body)
end
...
function Teams.createOrUpdateIdpGroupConnectionsLegacy(team_id, body)
	return Teams.Http:PATCH(("https://api.github.com/teams/%s/team-sync/group-mappings"):format(team_id), body)
end
