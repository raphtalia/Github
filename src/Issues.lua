...
function Issues.addAssigneesToAnIssue(owner, repo, issue_number, body)
	return Issues.Http.POST(("https://api.github.com/repos/%s/%s/issues/%s/assignees"):format(owner, repo, issue_number), nil, body)
end

function Issues.removeAssigneesFromAnIssue(owner, repo, issue_number, body)
	return Issues.Http.DELETE(("https://api.github.com/repos/%s/%s/issues/%s/assignees"):format(owner, repo, issue_number), nil, body)
end
...
function Issues.updateAnIssueComment(owner, repo, comment_id, body)
	return Issues.Http.PATCH(("https://api.github.com/repos/%s/%s/issues/comments/%s"):format(owner, repo, comment_id), nil, body)
end
...
function Issues.createAnIssueComment(owner, repo, issue_number, body)
	return Issues.Http.POST(("https://api.github.com/repos/%s/%s/issues/%s/comments"):format(owner, repo, issue_number), nil, body)
end
...
function Issues.addLabelsToAnIssue(owner, repo, issue_number, body)
	return Issues.Http.POST(("https://api.github.com/repos/%s/%s/issues/%s/labels"):format(owner, repo, issue_number), nil, body)
end

function Issues.setLabelsForAnIssue(owner, repo, issue_number, body)
	return Issues.Http.PUT(("https://api.github.com/repos/%s/%s/issues/%s/labels"):format(owner, repo, issue_number), nil, body)
end
...
function Issues.createALabel(owner, repo, body)
	return Issues.Http.POST(("https://api.github.com/repos/%s/%s/labels"):format(owner, repo), nil, body)
end
...
function Issues.updateALabel(owner, repo, name, body)
	return Issues.Http.PATCH(("https://api.github.com/repos/%s/%s/labels/%s"):format(owner, repo, name), nil, body)
end
...
function Issues.createAMilestone(owner, repo, body)
	return Issues.Http.POST(("https://api.github.com/repos/%s/%s/milestones"):format(owner, repo), nil, body)
end
...
function Issues.updateAMilestone(owner, repo, milestone_number, body)
	return Issues.Http.PATCH(("https://api.github.com/repos/%s/%s/milestones/%s"):format(owner, repo, milestone_number), nil, body)
end
