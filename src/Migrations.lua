...
function Migrations.startAnOrganizationMigration(org, body)
	return Migrations.Http:POST(("https://api.github.com/orgs/%s/migrations"):format(org), body)
end
...
function Migrations.updateGitLfsPreference(owner, repo, body)
	return Migrations.Http:PATCH(("https://api.github.com/repos/%s/%s/import/lfs"):format(owner, repo), body)
end
...
function Migrations.startAUserMigration(body)
	return Migrations.Http:POST(("https://api.github.com/user/migrations"):format(), body)
end
